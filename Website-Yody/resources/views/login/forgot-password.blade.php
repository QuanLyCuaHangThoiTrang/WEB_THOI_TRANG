            ...
            <div class="md:max-w-md w-full px-4">
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class=" mt-4 mb-12">
                        <h3 class="text-gray-800 text-3xl font-extrabold">Forgot your password?</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative flex items-center">
                            <input name="email" type="text" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600  py-3 outline-none" placeholder="Enter email" />
                        </div>
                        @error('email')
