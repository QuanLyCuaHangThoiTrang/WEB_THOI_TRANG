...
<div class="font-[sans-serif] bg-slate-200 py-2 mt-20">
    <div class="flex flex-col items-center justify-center">
        <div class="grid md:grid-cols-2 items-center bg-white gap-4 max-md:gap-8 max-w-5xl max-md:max-w-lg w-full p-4 m-4 shadow-lg rounded-lg">
            <div class="md:max-w-md w-full px-4">
                <form action="{{ route('login.postLogin') }}" method="POST">
                    ...
                    <div class="mb-12">
                        ...
                        <p class="text-sm mt-4 text-gray-600">Don't have an account? <a href="{{ url('/register') }}" class="text-yellow-600 font-semibold">Register here</a></p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input name="taikhoan" type="text" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none transition duration-200" placeholder="Enter username" />
                    </div>

                    <div class="mt-8">
                        <label class="text-gray-800 text-xs block mb-2">Password</label>
                        <div class="relative flex items-center">
                            <input id="password" name="matkhau" type="password" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none transition duration-200" placeholder="Enter password" autocomplete="current-password" />
                            <button type="button" id="toggle-password" class="absolute right-0 top-0 mt-3 mr-2 text-blue-500">
                                <span id="password-text" class="text-sm">Show</span>
                            </button>
                        </div>
                    </div>
            ...
            <div class="md:h-full bg-[#000842] rounded-xl lg:p-12 p-8">
                <img src="https://m.yodycdn.com/fit-in/filters:format(webp)/products/ao-khoac-ni-the-thao-nu-yody-swn6010-tra-03.jpg" class="w-full h-full object-contain rounded-lg shadow-lg" alt="login-image" />
            </div>
        </div>
    </div>
</div>
