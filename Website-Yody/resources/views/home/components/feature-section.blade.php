<section class="relative mt-12 shadow-3xl p-24 bg-cover bg-center"
    ...
    <div class="relative z-10">
        <div
            ...
            <div class="relative w-full text-center lg:text-left lg:w-2/4">
                <p class="text-xl font-medium leading-relaxed text-gray-200 mb-5">Chúng tôi luôn lắng nghe, thấu hiểu,
                    đổi mới. Từng bước
                    cải tiến để mang lại giá trị đích thực cho khách hàng,
                    xây dựng mối quan hệ bền vững và tạo nên sự khác biệt. Chúng tôi cam kết cung cấp những giải pháp
                    sáng tạo
                    và hiệu quả, giúp bạn vượt qua mọi thử thách và đạt được thành công lâu dài.</p>
