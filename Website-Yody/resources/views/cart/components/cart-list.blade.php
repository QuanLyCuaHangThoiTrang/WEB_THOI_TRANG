                                ...
                                <div class="flex bg-white px-4 py-6 border-b border-gray-200 gap-4 md:gap-8 items-center">
                                    ...
                                    <div class="flex-1 md:flex md:items-center">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <h6 class="font-medium text-base leading-7 text-gray-600">{{ number_format($chitiet->DonGia, 0, ',', '.') }} đ</h6>
                                            <span class="font-semibold w-10 h-10 border border-gray-300 flex items-center justify-center cursor-pointer transition duration-200 ease-in-out transform hover:scale-105" style="background-color: {{ $chitiet->chiTietSanPham->mauSac->TenMau }}"></span>
                                ...
                                <div class="flex bg-white px-4 py-6 border-b border-gray-200 gap-4 md:gap-8 items-center">
                                    ...
                                    <div class="flex-1 md:flex md:items-center">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <h6 class="font-medium text-base leading-7 text-red-600">{{ number_format($item['DonGia'], 0, ',', '.') }} đ</h6>
                                            <span class="font-semibold w-10 h-10 rounded-full hover:border-blue-700  border border-gray-300 flex items-center justify-center cursor-pointer transition duration-200 ease-in-out transform hover:scale-105" style="background-color: {{ $item['TenMau'] }}"></span>
