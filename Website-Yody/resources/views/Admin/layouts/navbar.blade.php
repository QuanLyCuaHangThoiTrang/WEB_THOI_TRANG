      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h3 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:darkblue">Welcome back to Admin</h3>
            <h3 class="welcome-sub-text">LOOK GOOD FEEL GOOD</h3>
          </li>
        </ul>
