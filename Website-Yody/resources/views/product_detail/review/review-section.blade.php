<div class="mt-8">
    ...
    <button id="toggleReviews" type="button" class="w-full mt-8 px-6 py-2.5 border border-yellow-600 bg-transparent text-gray-800 text-sm font-semibold rounded-md">Read all reviews</button>
...
<script>
    document.getElementById('toggleReviews').addEventListener('click', function() {
        ...
        reviewDetails.classList.toggle('hidden'); // Hiện/ẩn phần bình luận chi tiết
    });
</script>
