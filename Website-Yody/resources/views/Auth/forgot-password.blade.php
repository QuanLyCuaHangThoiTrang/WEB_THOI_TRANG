            ...
            <div class="md:max-w-md w-full px-4">
                <form action="{{ route('password.email') }}" method="POST">
                    ...
                    <div class="mt-4 mb-12">
                        <h3 class="text-gray-800 text-3xl font-extrabold">Quên mật khẩu?</h3>
                        <p class="text-sm mt-4 text-gray-800">Có tài khoản? <a href="{{ url('/login') }}" class="text-yellow-600 font-semibold hover:underline ml-1">Đăng nhập tại đây</a></p>
                    </div>

                    <div class="mb-4">
                        <label class="text-gray-800 text-xs block mb-2">Email</label>
                        <input name="email" type="email" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 py-3 outline-none" placeholder="Nhập email" />
                        @error('email')
