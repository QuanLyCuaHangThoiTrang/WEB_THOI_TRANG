...
<div class="bg-gray-100 px-12 pb-10">
    ...
    <!-- Option 1: Thanh toán bằng tiền mặt -->
                        <button type="button" class="">
                            <div class="h-48 w-full md:w-64 rounded-xl shadow hover:shadow-xl duration-150 hover:bg-white border flex flex-col items-center justify-center bg-gray-50">
                                <img src="{{ asset('/icons/money.png') }}" class="w-24 h-24" alt="">
                                <h1 class="mt-2 text-center">Thanh toán bằng tiền mặt</h1>
                            </div>
                        </button>

                        <!-- Option 2: Thanh toán bằng Momo -->
                        <button type="button" class="">
                            <div class="h-48 w-full md:w-64 rounded-xl shadow hover:shadow-xl duration-150 hover:bg-white border flex flex-col items-center justify-center bg-gray-50">
                    ...
                    <div class="mt-2 text-base">
                        ...
                        <form>
                            ...
                            <a href="{{ url('/cart/checkout') }}">
                                <button type="button" class="w-full bg-yellow-500 rounded-xl py-3 px-6 font-semibold text-lg text-white transition-all duration-500 hover:bg-yellow-400 shadow-sm border-b-2 border-b-yellow-700 shadow-yellow-600">Thanh toán</button>
                            </a>
