        ...
        <section class="container z-50  mx-auto py-2">    
            <div class=" py-5 border-b">
                ...
                <div class="w-full max-w-8xl mx-auto relative z-10">
                    <div class="modal fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50 hidden" id="voucherModal">
                        <div class="bg-white rounded-lg w-96 p-6">
                            ...
                            <form class="formabc" action="{{ route('checkout.applyVoucher') }}" method="POST">
                                ...
                                <div class="w-full mb-4">
                                    <input type="text" name="voucher_code" placeholder="Nhập mã giảm giá"  value="{{ old('voucher_code', session('MaVC', '')) }}"
                                        class="w-full outline-none bg-gray-100 text-gray-600 uppercase text-sm px-4 py-2 border border-gray-300 rounded-md" />
                                </div>
                                <button type='submit' id="applyBtn" class="w-full bg-blue-800 hover:bg-blue-700 text-white px-4 py-2 rounded-md">
                                    Áp dụng
                                </button>
                                <!-- Hiển thị thông báo thành công -->
                               
                            </form>
                            <button class=" w-full bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-md" id="closeModalBtn">Đóng</button>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col bg-white px-7 py-5 border-b border-gray-200 gap-4 md:gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ Auth::check() ? Auth::user()->Email : '' }}" name="email" type="text" required
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500"
    ...
    if (document.getElementById('addNewAddress').checked) {
        ...
        newAddressContainer.classList.add('hidden');
                                ...
                                <div>
                                    ...
                                    <input value="{{ Auth::check() ? Auth::user()->SDT : '' }}" name="phone_number" type="text" required
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500"
                        ...
                        <div class="w-full lg:w-[400px] bg-white p-6 xl:p-10 max-w-3xl xl:max-w-lg mx-auto py-4 border ">
                            ...
                            <div class="mt-2 text-base text-center">
                                <button id="openModalBtn" class=" bg-black hover:bg-gray-800 duration-300 text-white w-full rounded-full py-2">
                                    Nhập mã giảm giá
                                </button>
                            </div>
