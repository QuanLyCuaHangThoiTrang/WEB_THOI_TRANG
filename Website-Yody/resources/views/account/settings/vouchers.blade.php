                            ...
                            <div class="flex flex-col px-7 gap-4 p-4">
                                <div class="border-b">
                                    <div class="flex items-baseline justify-between border-b border-gray-200 py-5">
                                        <div>
                                            <p class="text-black font-semibold text-3xl">Điểm tích lũy:
                                                ...
                                                <div class="flex space-x-2">
                                                    <div class="flex-shrink-0 pt-3">
                                                        <select name="sort" id="sort-select"
                                                            class="border-2 border-gray-300 py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:border-black hover:border-gray-600 duration-500 border-l-[7px] focus:outline-none rounded-md mt-2 sm:mt-0">
                                            ...
                                            @else
                                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                                    @foreach ($vouchers as $voucher)
                                                        <div
                                                            class="bg-gradient-to-br from-blue-950 to-blue-900 flex flex-col text-center text-white justify-center items-center rounded-lg shadow-md p-4">
                                                            <h3 class="text-2xl border-b-2 font-bold uppercase">
