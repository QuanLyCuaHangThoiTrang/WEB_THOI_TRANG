                ...
                <form class="hidden lg:block">
                    <div>
                        <ul role="list" class="space-y-4 border-gray-200 pb-6 text-sm font-medium text-gray-900">
                            <li><a href="{{ url('/account/' . $khachhang->MaKH) }}">Account</a></li>
                            <li><a href="{{ url('/addresses/' . $khachhang->MaKH) }}">Address</a></li>
                            <li><a href="{{ url('/voucher/{MaKH}') }}">Voucher</a></li>
                            <li><a href="{{ url('/order-history/{MaKH}') }}">Order History</a></li>
                        </ul>
                    </div>
                </form>
                        ...
                        <div class="flex flex-col px-7 gap-4 p-6">
                            ...
                            <form method="POST" action="{{ route('addresses.create') }}">
                                ...
                                <div class="my-4 flex justify-end">
                                    <button type="submit" class="button bg-blue-900 px-16 py-2 text-white hover:bg-blue-500 focus:border-black transition duration-200 focus:outline-none  rounded-md shadow-md">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="col-span-3 bg-gray-50 border-l">
                                    ...
                                    <div class="flex-1 w-full max-xl:max-w-3xl max-xl:mx-auto">
                                        <div class="flex flex-col bg-gray-50 px-7 gap-4 md:gap-4 p-6">
                                            <div class="border-b">
                                                <h3 class="text-3xl font-semibold text-gray-900 mb-4" id="account-details-heading">Address List</h3>
                                            </div>
                                            @foreach($addresses as $index => $address) <!-- Sử dụng $index để đánh số thứ tự -->
