      ...
      <form class="mt-4 border-t border-gray-200">
        ...
        <div class="border-t border-gray-200 px-4 py-6">
          ...
          <div class="pt-6 hidden" id="filter-section-mobile-1">
            <div class="space-y-6">
              <div class="flex items-center">
                <input id="filter-mobile-size-0" name="size[]" value="small" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                <label for="filter-mobile-size-0" class="ml-3 min-w-0 flex-1 text-gray-500">Small</label>
              </div>
...
<main class="mx-auto max-w-7xl mt-14 px-4 sm:px-6 lg:px-4">
  <div class="flex items-baseline justify-between border-b border-gray-200 pt-12">
    ...
    <div class="flex items-center p-6">
      ...
      <button id="filter-button" class="ml-4 lg:hidden text-gray-700 hover:text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
