        ...
        <section aria-labelledby="products-heading" class="pb-24 pt-6">
            <div class="grid grid-cols-1 gap-x-10 gap-y-10 lg:grid-cols-4">
                ...
                <div id="offcanvas-filter" class="fixed inset-0 bg-gray-800 bg-opacity-50 z-50 hidden">
                    <div class="absolute right-0 top-0 w-80 max-w-full h-full bg-white overflow-y-auto">
                                    ...
                                    <div class="grid grid-cols-4 gap-4">
                                        @foreach ($MauSacs as $item)
                                            <div class="flex items-center justify-center">
                                                <input id="filter-color-{{ $loop->index }}" name="color[]"
                                                    value="{{ $item->TenMau }}" type="checkbox"
                                                    class="hidden custom-checkbox2">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                        @foreach ($KichThuocs as $item)
                                            <div class="flex items-center space-x-4">
                                                <label for="filter-size-{{ $loop->index }}"
                                                    class="flex items-center cursor-pointer space-x-2">
                                                    <input id="filter-size-{{ $loop->index }}" name="size[]"
                                                        value="{{ $item->TenSize }}" type="checkbox"
                                                        class="hidden custom-checkbox3">
                                                    <span
